  ...
  return (
    <main className="max-w-3xl mx-auto p-5 space-y-8 mt-20">
      ...
      <p className="text-lg text-center">
        ...
        una mejor atención, por favor registrar la solicitud de visita siguiendo
        estos simples pasos.
      </p>
      ...
      <div className="space-y-4">
        ...
        <ol className="space-y-3 text-lg">
          ...
          <li className="p-4 bg-gray-100 rounded-lg shadow-sm">
            ...
            Una vez enviado, tu visita entrara en proceso de revisión, en cuanto
            se acepte se le enviará a su correo un documento con el registro de
            la visita.
          </li>
        </ol>
      </div>
